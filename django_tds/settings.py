...
ALLOWED_HOSTS = []
if HEROKU_APP:
    ALLOWED_HOSTS.append(HEROKU_APP)
...
WSGI_APPLICATION = 'django_tds.wsgi.application'
...
# Geo ip2 country db
GEO_IP2_DB_PATH = os.environ.get('GEO_IP2_DB_PATH')
if not GEO_IP2_DB_PATH:
    GEO_IP2_DEFAULT_PATH = os.path.join(
        BASE_DIR,
